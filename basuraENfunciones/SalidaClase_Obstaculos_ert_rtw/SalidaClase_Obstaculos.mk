###########################################################################
## Makefile generated for component 'SalidaClase_Obstaculos'. 
## 
## Makefile     : SalidaClase_Obstaculos.mk
## Generated on : Wed Jan 08 17:19:29 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SalidaClase_Obstaculos.elf
...
PRODUCT_NAME              = SalidaClase_Obstaculos
MAKEFILE                  = SalidaClase_Obstaculos.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SalidaClase_Obstaculos.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/SalidaClase_Obstaculos_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_STANDARD = -DMODEL=SalidaClase_Obstaculos -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_ArduinoEncoder.o SalidaClase_Obstaculos.o SalidaClase_Obstaculos_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o Sensores_VL53L0X_I2C_cgen_wrapper.o Sensores_VL53L0X_I2C_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SalidaClase_Obstaculos.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/SalidaClase_Obstaculos.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SalidaClase_Obstaculos_data.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/SalidaClase_Obstaculos_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Sensores_VL53L0X_I2C_cgen_wrapper.o : $(START_DIR)/SalidaClase_Obstaculos_ert_rtw/Sensores_VL53L0X_I2C_cgen_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
