###########################################################################
## Makefile generated for component 'Copy_of_Control9_PuntosM'. 
## 
## Makefile     : Copy_of_Control9_PuntosM.mk
## Generated on : Mon Jan 06 00:07:38 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_Control9_PuntosM.elf
...
PRODUCT_NAME              = Copy_of_Control9_PuntosM
MAKEFILE                  = Copy_of_Control9_PuntosM.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_Control9_PuntosM.elf
...
DEFINES_STANDARD = -DMODEL=Copy_of_Control9_PuntosM -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_ArduinoEncoder.o Copy_of_Control9_PuntosM.o Copy_of_Control9_PuntosM_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o Sensores_VL53L0X_I2C_cgen_wrapper.o Sensores_VL53L0X_I2C_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Copy_of_Control9_PuntosM.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/Copy_of_Control9_PuntosM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copy_of_Control9_PuntosM_data.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/Copy_of_Control9_PuntosM_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Sensores_VL53L0X_I2C_cgen_wrapper.o : $(START_DIR)/Copy_of_Control9_PuntosM_ert_rtw/Sensores_VL53L0X_I2C_cgen_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
