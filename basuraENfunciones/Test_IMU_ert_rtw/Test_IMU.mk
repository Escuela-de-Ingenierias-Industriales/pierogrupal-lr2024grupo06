###########################################################################
## Makefile generated for component 'Test_IMU'. 
## 
## Makefile     : Test_IMU.mk
## Generated on : Thu Dec 26 10:06:56 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Test_IMU.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Test_IMU.elf
...
DEFINES_STANDARD = -DMODEL=Test_IMU -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduinoI2C.o io_wrappers.o xcp_ext_mode.o Test_IMU.o Test_IMU_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Test_IMU_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/Test_IMU_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/Test_IMU_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
Test_IMU.o : $(START_DIR)/Test_IMU_ert_rtw/Test_IMU.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


Test_IMU_data.o : $(START_DIR)/Test_IMU_ert_rtw/Test_IMU_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/Test_IMU_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
