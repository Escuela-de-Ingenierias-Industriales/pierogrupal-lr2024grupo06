 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Jan 04 17:22:17 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Sensores_VL53L0X_I2C
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                Sensor_izq
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                Sensor_der
...
extern void Sensores_VL53L0X_I2C_Outputs_wrapper(real_T *Sensor_izq,
  real_T *Sensor_der,
  const real_T *xD);
extern void Sensores_VL53L0X_I2C_Update_wrapper(real_T *Sensor_izq,
  real_T *Sensor_der,
  real_T *xD);
...
{
  real_T *Sensor_izq = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *Sensor_der = (real_T *) ssGetOutputPortRealSignal(S, 1);
  const real_T *xD = ssGetDiscStates(S);
  Sensores_VL53L0X_I2C_Outputs_wrapper(Sensor_izq, Sensor_der, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  Sensores_VL53L0X_I2C_Update_wrapper(Sensor_izq, Sensor_der, xD);
}
